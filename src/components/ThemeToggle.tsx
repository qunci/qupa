  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex w-full justify-between items-center px-1.5 pointer-events-none">
        <svg className="h-[16px] w-[16px] text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
        <svg className="h-[15px] w-[15px] text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      <span
        className={`pointer-events-none relative inline-block h-[24px] w-[24px] rounded-full bg-white dark:bg-slate-950 shadow-sm ring-0 transition-transform duration-300 ease-in-out z-10 flex items-center justify-center ${
