  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-950 flex flex-col h-screen sticky top-0 transition-colors duration-300 shrink-0">
      ...
      <div className="h-20 flex items-center px-6 shrink-0">
        <Link href="/" className="flex items-center gap-3 group select-none outline-none transition-opacity hover:opacity-80 rounded-md focus-visible:ring-2 focus-visible:ring-blue-500">
